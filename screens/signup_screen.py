...
class Signup_screen():
    def __init__(self, app):
        ...
        self.success=0
        self.recovery_questions=["your first dog","your first crush","your favourite flavour","your favourite uncle","your secret talent"]
    ...
    def insert_into_database(self,name,username,password):
        ...
        if(q):
            ...
            self.already_exists=0
            self.database_handler.insert({"username":self.u,"password":self.p,"recovery_question":self.recovery_questions[self.recovery_index],"recovery_answer":self.n})
